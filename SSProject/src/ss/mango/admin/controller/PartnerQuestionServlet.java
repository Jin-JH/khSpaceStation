...
/**
 * Servlet implementation class PartnerQuestionServlet
 */
@WebServlet("/partnerQuestion.ss")
public class PartnerQuestionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PartnerQuestionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InquiryPageData ipd = new AdminService().partnerQuestion(inquiryState, currentPage);
		
		RequestDispatcher view = request.getRequestDispatcher("/views/admin/pManage/pManageQuestion.jsp");
