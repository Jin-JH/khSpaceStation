 ...
 */
@WebServlet("/apprSearchSignOut.ss")
public class ApprovalSearchSignOutServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApprovalSearchSignOutServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String aprovType;
			...
			if(result>0) {
				...
				RequestDispatcher view = request.getRequestDispatcher("/searchSignOutUser.ss");
				...
				out.println("<script>location.replace('/signOutUser.ss');</script>");		
			}//if, else
