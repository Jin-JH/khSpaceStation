 ...
 */
@WebServlet("/apprSignOutPartner.ss")
public class ApprovalSignOutPartnerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApprovalSignOutPartnerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String aprovType;
			...
			if(result>0) {
				//상태변경이 정상적으로 처리되었다면
				response.sendRedirect("/signOutPartner.ss");
