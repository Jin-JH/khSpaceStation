...
/**
 * Servlet implementation class ChartUserCountServlet
 */
@WebServlet("/chartUserCount.ss")
public class ChartUserCountServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChartUserCountServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Quarter> searchJoin = new ChartService().quarterJoinUserCount(year);
		ArrayList<Quarter> searchEnd = new ChartService().quarterEndUserCount(year);
