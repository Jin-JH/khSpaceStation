...
/**
 * Servlet implementation class InquiryPartnerListPageServlet
 */
@WebServlet("/InquiryPartnerListPage.ss")
public class InquiryPartnerListPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InquiryPartnerListPageServlet() {
        super();
...
int presentPage;
		...
		RequestDispatcher view = request.getRequestDispatcher("/views/user/mypage/myPage_InquiryPartner.jsp");
