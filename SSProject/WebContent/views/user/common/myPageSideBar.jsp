...
<body>
	<div id="navigation" class="col-12">
		<ul class="ulStyle">
			...
			<li class="liStyle">
				<a href="/MemberReservation.ss" class="aStyle aHover">
					<span class="spanLi">나의 예약현황</span>
				</a>
			</li>
			<li class="liStyle">
				<a href="/views/user/mypage/myPage_ModifyUserInfo.jsp" class="aStyle aHover">
					<span class="spanLi">회원정보 수정</span>
				</a>
			</li>

			<li class="liStyle">
				<a href="/InquiryListPage.ss" class="aStyle aHover">
					<span class="spanLi">1:1 문의</span>
				</a>
			</li>
		</ul>
	</div>
