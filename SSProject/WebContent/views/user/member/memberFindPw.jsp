...
<body>
	<div class="wrapper">
        ...
        <div class="main-content" id="container">
        	<div id="find_pw_box" class="p-0">
                ...
                <form action="/memberFindPw.ss" method="post">
                	<div class="row m-0 p-0">
                		<div class="find_form col-12 p-0" style="margin: 0 auto">
	                        ...
	                        <div class="row find_info m-0 p-0">
	                            <div class="col-3 col-md-4 find_left_style">
	                                <span class="span_style">아이디</span>
	                            </div>
	                            <div class="col-9 col-md-8">
	                                <input type="text" class="find_info_input" name="findId" size="30"/> 
	                                &nbsp;
	                            </div>
	                        </div>
	                        <div class="row find_info m-0 p-0">
	                        ...
	                        <div class="row find_info m-0 p-0" id="find_pw_email">
	                            <div class="col-3 col-md-4 find_left_style">
	                                <span class="span_style">이메일로 찾기</span>
	                            </div>
	                            <div class="col-9 col-md-8">
	                                <input type="text" class="find_info_input" name="findPwEmail" size="30"/> 
	                                &nbsp;
	                            </div>
	                        </div>
	                        <div class="row find_info m-0 p-0 d-none" id="find_pw_phone">
	                            <div class="col-3 col-md-4 find_left_style">
	                                <span class="span_style">휴대폰번호로 찾기</span>
	                            </div>
	                            <div class="col-9 col-md-8">
	                                <input type="text" class="find_info_input" name="findPwPhone" size="30"/> 
	                                &nbsp;
	                            </div>
	                        </div>
                		</div>
                		<div class="col-12" style="margin: 0 auto; padding-top: 20px;">
				            <div class="col-12 m-0 p-0 find_pw_content">
				            	<input type="submit" value="확인" class="btn btn-dark" id="find_pw_submit">
				            </div>
			            </div>
                	</div>
                </form>
    ...
    <script>
    	$('input[value=email]').click(function() {
    		$('#find_pw_email').removeClass('d-none');
    		$('#find_pw_phone').addClass('d-none');
    	});
    	$('input[value=phone]').click(function() {
    		$('#find_pw_phone').removeClass('d-none');
    		$('#find_pw_email').addClass('d-none');
    	});
    </script>
    <script>
		var $windowWidth;
