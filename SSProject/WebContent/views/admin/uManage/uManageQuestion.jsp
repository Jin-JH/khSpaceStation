    ...
    <div id="fluid" class="container-fluid">
        ...
        <div id="content" class="row padding1 bgColor1">
			...
			<div id="whiteBoard" class="col-12 padding1 bgColor2">
				<div id="inquiry" class="padding1">사용자 문의사항 목록
				        ...
				        <c:choose>
				        	...
				        	<c:otherwise>
				        		<c:forEach items="${list }" var="i">
				        			<tr>
				        				<td>${i.inquiryNo }</td>
				        				<td><a href="/userQuestionText.ss?inquiryNo=${i.inquiryNo }">${i.inquiryTitle }</a></td>
				        				<td>${i.memberId }</td>
				        				<td>${i.inquiryDate }</td>
				        				<td>
				        					<c:choose>
...
<script>
	...
	$(function(){
		...
		$('#qAaState').change(function(){
			...
			location.replace("/userQuestion.ss?inquiryState="+inquiryState);
		});
	});
</script>
