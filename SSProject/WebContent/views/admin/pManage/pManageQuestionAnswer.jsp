    ...
    <div id="fluid" class="container-fluid">
        ...
        <div id="content" class="row padding1 bgColor1">
			...
			<div class="col-12">
				...
				<form action="/partnerQuestionAnswer.ss?inquiryNo=${inquiry.inquiryNo }" method="post" id="answerForm">
...
<c:choose>
	<c:when test="${result==true }">
		<script>
			$(function(){
				alert("답변 완료!");
				location.replace("/partnerQuestion.ss");
			});
		</script>
	</c:when>
