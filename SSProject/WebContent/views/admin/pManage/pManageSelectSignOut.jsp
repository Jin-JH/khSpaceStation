					...
					<table class="tableStyle"> <!--infoTable클래스 추가-->
				        ...
				        <c:choose>
				        	<c:when test="${empty list}">
				        		<td colspan=8 align="center">사업자 정보가 없습니다.</td>
				        	</c:when>
				        	<c:otherwise>
				        		...
				        		<tr>
					        		...
					        		<td class="apprStateTd">
			     						<form action="/apprSearchSignOutPartner.ss?selectWord=${selectWord}&keyword=${keyword}" method="post" class="apprStateForm">
